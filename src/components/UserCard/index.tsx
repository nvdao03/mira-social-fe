    ...
    <Link to={''} className='flex items-center justify-between py-2'>
      <div className='flex gap-x-3'>
        <div className='w-10 h-10 rounded-full'>
          <img src={AvatarDefault} alt='' className='w-full h-full object-center rounded-full' />
        </div>
        <div className='h-10 flex flex-col gap-y-2 justify-center'>
          <div className='flex items-center'>
            <span className='hover:underline text-[15px] font-semibold truncate max-w-[100px]'>OpenAI</span>
            <svg
              viewBox='0 0 22 22'
